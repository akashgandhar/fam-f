...
const GiftCardContainer = () => {
  ...
  useEffect(() => {
    const fetchGiftCards = async () => {
      try {
        const response = await axios.get(
          "https://backend.familyvibes.in/getAllGiftCards"
        );
    ...
    const fetchFrameSizes = async () => {
      try {
        const response = await axios.get(
          "https://backend.familyvibes.in/getGiftCardFrames"
        );
  ...
  async function buyFramesToPhonePay(initPayment) {
    ...
    try {
      const result = await authAxios.post(
        "https://backend.familyvibes.in/promo/orderId",
        initPayment,
        { headers: header }
      );
      const { data } = result;
      ...
      <section id="gift_cards" className="container py-5 my-lg-5">
        <div className="row">
          <div className="col-12 text-center pb-4">
            ...
            <h2 className="my-4 py-lg-3 wow fadeInDown">
              Family Vibes Gift Card
            </h2>
          </div>
        </div>
        <div className="row">
            ...
            <div className="formCard">
              <div className="paddIng wow fadeInRight">
                ...
                <ol className="mb-0">
                  ...
                  <li>
                    They can order from Family Vibes website and apply the gift
                    code at checkout!
                  </li>
                </ol>
              </div>
              ...
              <form className="paddIng">
                ...
                <div className="form-group mb-1  wow fadeInDown">
                  ...
                  {giftCards?.length > 0 &&
                    giftCards
                      ?.sort((a, b) => a.noOfFrames - b.noOfFrames)
                      .map((giftCards, index) => (
                        <div
                ...
                <div className="form-group d-flex align-items-center wow fadeInDown">
                  ...
                  <label htmlFor="shipincluded" className="mb-0 ml-2">
                    Shipping Included{" "}
                  </label>
                </div>
          ...
          <div className="col-lg-6">
            <img
              src="/assets/images/form-card.png"
              alt="Form Card Image"
              className="img-fluid formCardImg"
            />
          </div>
        </div>
      </section>
